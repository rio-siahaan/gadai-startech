!(function (n) {
    ...
    function t(e) {
        ...
        var cssPath = "assets/css/app.min.css";
        var cssPath2 = "assets/css/bootstrap.min.css";

        // Create the complete URL by concatenating the base URL and the relative path
        var completeUrl = baseUrl + "/" + cssPath;
        var completeUrl2 = baseUrl + "/" + cssPath2;
        ...
        "light-mode-switch" === e
            ? (n("html").removeAttr("dir"),
              ...
              n("#bootstrap-style").attr("href", completeUrl2),
              n("#app-style").attr("href", completeUrl),
