                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 text-end">
                                <div class="button-items">
                                    <form method="post" action="{{ route('admin.userDetail.post', ['user' => $user->id]) }}">
                                        @csrf
                                        <button type="submit" class="btn btn-danger waves-effect waves-light" name="action" value="blokir">
                                            <i class="ri-close-line align-middle me-2"></i> Blokir
                                        </button>
                                </div>
                            </div>
                        </div>
